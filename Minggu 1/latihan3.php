...
$kendaraan1 = new Kendaraan("Fortuner 2,4 G MT", "Mobil", 4, "Toyota", "Diesel", 512000000, 2009);
...
$kendaraan2 = new Kendaraan("XSR 155", "Sepeda Motor", 2, "Yamaha", "Premium", 36000000, 2005);
