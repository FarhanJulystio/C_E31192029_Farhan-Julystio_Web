...
$bilangan->setBilangan1(70);
$bilangan->setBilangan2(10);
$bilangan->setBilangan3(8);

echo "PERHITUNGAN BILANGAN : <b>{$bilangan->getBilangan1()}</b>, <b>{$bilangan->getBilangan2()}</b>, <b>{$bilangan->getBilangan3()}</b> <br><br>";

echo '<b>Penjumlahan Dari :</b><br>';
echo $bilangan->tambah();
echo '<br><br>';

echo '<b>Pengurangan Dari :</b><br>';
echo $bilangan->kurang();
echo '<br><br>';

echo '<b>Pembagian Dari :</b><br>';
echo $bilangan->bagi();
echo '<br><br>';

echo '<b>Perkalian Dari :</b><br>';
echo $bilangan->kali();